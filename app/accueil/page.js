export default function Accueil() {
  return (
    <div className="bg-[#080A08] min-h-screen">
      ...
      {/* HERO */}
      <div className="min-h-screen flex items-center px-6 md:px-16 lg:px-32 xl:px-40 py-24 max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={s.num} className="bg-[#111311] border border-white/5 rounded-xl p-7 relative overflow-hidden">
                ...
                <p className="text-[#C8C8C2] text-sm leading-relaxed">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
