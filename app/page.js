...
export default function Accueil() {
  ...
  return (
    <div className="bg-bg-primary min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 w-full">
          <div className="flex-1 w-full">
            <div className="flex items-center gap-2 mb-6 flex-wrap">
              <span className="text-[10px] tracking-widest uppercase px-3 py-1 rounded-full border border-brand-amber text-brand-amber">Beta</span>
              <span className="text-[10px] tracking-widest uppercase px-3 py-1 rounded-full border border-line-strong text-ink-muted">Open source</span>
            </div>
            <h1 className="font-display text-[clamp(36px,5vw,60px)] font-extrabold leading-[1.07] tracking-[-2px] mb-6 text-ink-title">
              Your wallet:<br />
              <span className="text-brand-green">a silent alarm</span><br />
              under <span className="text-brand-terracotta">duress</span>.
            </h1>
            <p className="text-ink-body text-lg leading-relaxed mb-10 max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-start">
              <a href="/register" className="inline-block px-7 py-3.5 bg-ink-title text-white rounded-lg font-bold text-sm hover:opacity-90 transition-opacity">Try Wallert</a>
              <a href="#how" className="inline-block px-7 py-3.5 text-ink-muted text-sm hover:text-ink-title transition-colors">See how it works ↓</a>
            </div>
          </div>
          <div className="w-full max-w-[300px] lg:max-w-[320px] mx-auto lg:mx-0 shrink-0">
            <div className="bg-bg-cream border border-line rounded-2xl p-7">
              <div className="flex items-start gap-4 pb-5 border-b border-line">
                <div className="w-9 h-9 rounded-lg bg-bg-mint border border-brand-green flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-ink-title text-sm font-medium">Security wallet</p>
              ...
              <div className="flex items-start gap-4 py-5 border-b border-line">
                <div className="w-9 h-9 rounded-lg bg-bg-peach border border-brand-amber flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-ink-title text-sm font-medium">Outgoing transfer</p>
                  <p className="text-ink-muted text-xs mt-1">Signal triggered instantly</p>
                </div>
              </div>
              <div className="flex items-start gap-4 pt-5">
                <div className="w-9 h-9 rounded-lg bg-bg-peach border border-brand-terracotta flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-ink-title text-sm font-medium">Trusted circle notified</p>
                  <div className="flex gap-2 mt-2">
                    <span className="text-xs px-2.5 py-1 rounded-full bg-bg-peach border border-brand-terracotta text-brand-terracotta">Email</span>
                    <span className="text-xs px-2.5 py-1 rounded-full bg-bg-peach border border-brand-terracotta text-brand-terracotta">Telegram</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* THE THREAT */}
      <div className="bg-bg-peach border-t border-line">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-20">
          <p className="text-brand-terracotta text-[11px] font-semibold tracking-[3px] uppercase mb-4">The threat</p>
          <h2 className="font-display text-[clamp(26px,3.5vw,44px)] font-extrabold tracking-tight leading-[1.12] mb-6 text-ink-title">
            Hardware wallets protect your keys.<br />
            Nothing protects <em>you</em>.
          </h2>
          <p className="text-ink-body text-base leading-relaxed max-w-2xl mb-10">
          ...
          <p className="text-ink-title text-base font-bold leading-relaxed max-w-2xl mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 max-w-4xl">
            <div className="bg-bg-primary border border-brand-terracotta rounded-xl p-7">
              <p className="font-display text-xl md:text-2xl font-bold leading-snug">
                <span className="text-brand-terracotta">The attacker</span><br />
                <span className="text-ink-title">sees a transfer.</span>
              </p>
            </div>
            <div className="bg-bg-mint border border-brand-green rounded-xl p-7">
              <p className="font-display text-xl md:text-2xl font-bold leading-snug">
                <span className="text-brand-green">Your circle</span><br />
                <span className="text-ink-title">receives an alarm.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* HOW IT WORKS */}
      <div className="bg-bg-cream border-t border-line" id="how">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-20">
          <p className="text-brand-green text-[11px] font-semibold tracking-[3px] uppercase mb-4">Protocol</p>
          <h2 className="font-display text-[clamp(26px,3.5vw,44px)] font-extrabold tracking-tight leading-[1.12] mb-12 text-ink-title">Three steps. No complexity.</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={s.num} className="bg-bg-primary border border-line rounded-xl p-7 border-t-2 border-t-brand-green">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-brand-green text-xs font-mono tracking-widest">{s.num}</span>
                  <h3 className="font-display text-ink-title font-bold text-base">{s.title}</h3>
                </div>
                <p className="text-ink-body text-base leading-relaxed">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CAPABILITIES */}
      <div className="bg-bg-primary border-t border-line">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-20">
          <p className="text-brand-green text-[11px] font-semibold tracking-[3px] uppercase mb-4">Capabilities</p>
          <h2 className="font-display text-[clamp(26px,3.5vw,44px)] font-extrabold tracking-tight leading-[1.12] mb-12 text-ink-title">Simple to configure.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={f.title} className="border border-line rounded-xl p-6 hover:border-brand-green hover:bg-bg-mint transition-all">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-brand-green">{f.icon}</span>
                  <h4 className="font-display text-ink-title font-semibold text-base">{f.title}</h4>
                </div>
                <p className="text-ink-muted text-base leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ABOUT */}
      <div className="bg-bg-mint border-t border-line">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-20">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            <div className="lg:w-[340px] shrink-0">
              <p className="text-brand-green text-[11px] font-semibold tracking-[3px] uppercase mb-4">Why it exists</p>
              <h2 className="font-display text-[clamp(24px,3vw,36px)] font-extrabold tracking-tight leading-[1.15] mb-6 text-ink-title">I've seen both sides.</h2>
              <p className="text-ink-body text-base leading-relaxed mb-4">I am Rémi D'Alise. 6 years as Head of Product at Ledger. I know what hardware wallets protect, and what they don't.</p>
              <p className="text-ink-body text-base leading-relaxed">Since 2024, I've been helping crypto holders secure their funds. As the physical threat is real and growing, I built Wallert first for myself. Then for everyone.</p>
            </div>
            <div className="flex-1">
              <blockquote className="border-l-2 border-brand-green pl-6 mb-8">
                <p className="text-ink-title text-lg leading-relaxed italic font-display">"When you're under threat, the only thing that matters is that someone knows. Wallert's purpose is to break the silence as fast as possible."</p>
              </blockquote>
              <p className="text-ink-body text-base leading-relaxed mb-4">The best solution is often to remove yourself from the equation entirely: no easy access to your funds. But not everyone can make that choice.</p>
              <p className="text-ink-body text-base leading-relaxed mb-8">For those who hold directly: this is a safety net. Not a guarantee. An extra layer that costs nothing to activate, and could matter when nothing else does.</p>
              <div className="bg-bg-peach border border-brand-amber rounded-xl p-5">
      ...
      <div className="bg-bg-primary border-t border-line">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-20">
          ...
          <h2 className="font-display text-[clamp(26px,3.5vw,44px)] font-extrabold tracking-tight leading-[1.12] mb-4 text-ink-title">Designed to leave no trace.</h2>
          <p className="text-ink-body text-base max-w-lg mb-12">A security tool must not become a risk vector. Wallert is built to minimize exposure, even in a compromise scenario.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={s.title} className="flex items-start gap-4 border border-line rounded-xl p-6 bg-bg-primary">
                <div className="w-6 h-6 rounded-md bg-bg-mint border border-brand-green flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  <h4 className="font-display text-ink-title font-semibold text-base mb-1.5">{s.title}</h4>
                  <p className="text-ink-muted text-base leading-relaxed">{s.desc}</p>
                  {s.hasGithub && (
                    <a href="https://github.com/rmdls2b/wallert" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-3 text-brand-green text-sm font-medium hover:opacity-80 transition-opacity">
      ...
      {/* CTA FINAL */}
      <div className="bg-bg-cream border-t border-line">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-24 text-center">
          ...
          <h2 className="font-display text-[clamp(28px,4vw,52px)] font-extrabold tracking-tight leading-[1.1] mb-4 text-ink-title">
            Set it up once.<br />Hope to never use it.
          </h2>
          <p className="text-ink-body text-base mb-10 max-w-md mx-auto">Takes 5 minutes. Then you don't think about it anymore.</p>
          <a href="/register" className="inline-block px-10 py-4 bg-ink-title text-white rounded-lg font-bold text-base hover:opacity-90 transition-opacity">Try Wallert</a>
        </div>
      </div>
      ...
      <footer className="border-t border-line bg-bg-primary">
        <div className="px-6 md:px-16 lg:px-32 xl:px-40 max-w-[1400px] mx-auto py-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <p className="text-ink-faint text-sm">© 2025 Wallert. Open source project.</p>
            <div className="flex items-center gap-6">
              <a href="/about" className="text-ink-muted text-sm hover:text-ink-title transition-colors">Behind Wallert</a>
              <a href="https://github.com/rmdls2b/wallert" target="_blank" rel="noopener noreferrer" className="text-ink-muted text-sm hover:text-ink-title transition-colors flex items-center gap-2">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d={githubPath} /></svg>
                GitHub
              </a>
              <a href="mailto:contact@wallert.app" className="text-ink-muted text-sm hover:text-ink-title transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </footer>
