          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            <div className="lg:w-[340px] shrink-0">
              ...
              <p className="text-[#C8C8C2] text-base leading-relaxed mb-4">
                6 years as Head of Product at Ledger. I know what hardware wallets protect, and what they don't.
              </p>
              <p className="text-[#C8C8C2] text-base leading-relaxed">
                Since 2024, I've been helping crypto holders securing their funds. As the physical threat is real and growing, I built Wallert first for myself. Then for everyone.
              </p>
            </div>
            <div className="flex-1">
              ...
              <p className="text-[#C8C8C2] text-base leading-relaxed mb-4">
                The best solution is often to remove yourself from the equation entirely: no easy access to your funds. But not everyone makes that choice.
              </p>
